...
function ok(type?: Type<unknown> | Function | [Function] | string): ApiResponseOptions {
	return {
...
function created(type?: Type<unknown> | Function | [Function] | string): ApiResponseOptions {
	return {
